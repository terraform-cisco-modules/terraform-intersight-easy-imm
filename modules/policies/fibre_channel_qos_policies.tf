...
variable "fibre_channel_qos_policies" {
  ...
  * burst - Defualt is 1024.  The burst traffic, in bytes, allowed on the vHBA.  Value can be between 1024-1000000.
  ...
  * max_data_field_size - Defualt is 2112.  The maximum size of the Fibre Channel frame payload bytes that the virtual interface supports.
