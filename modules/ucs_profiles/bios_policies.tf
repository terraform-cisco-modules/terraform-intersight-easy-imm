...
variable "bios_policies_templates" {
  default = {
    default = {
...
module "bios_policies_nvmeof" {
  ...
  profiles = [
    ...
    if local.ucs_server_profiles[s].profile.bios_policies == each.key
  ]
  #+++++++++++++++++++++++++++++++
