...
module "policies_sd_card" {
  ...
  profiles = [
    ...
    if local.ucs_server_profiles[s].profile.policies_sd_card == each.key
  ]
}

module "policies_sd_card_os" {
  depends_on = [
    local.org_moids,
    module.ucs_server_profiles
  ]
...
module "policies_sd_card_utiity" {
  depends_on = [
    local.org_moids,
    module.ucs_server_profiles
  ]
